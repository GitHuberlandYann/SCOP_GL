...
Camera::Camera( glm::vec3 position ) : _movement_speed(SPEED), _mouse_sensitivity(SENSITIVITY), _zoom(ZOOM)
{
	_position = position;
...
{
	return (glm::perspective(glm::radians(_zoom), (GLfloat)WIN_WIDTH / (GLfloat)WIN_HEIGHT, 0.1f, 100.0f));
}
